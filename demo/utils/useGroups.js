...
export default ({ columnData: { allColumnHeaders, allColumnKeys } }) => {
    ...
    /*
         ...
         */
    const groupColumnKey = computed(() => allColumnKeys[allColumnHeaders.indexOf(currentGroup.value)]);
    ...
    return { groupData, groupHash, groupTitles, currentGroup, onGroupUpdate, groupColumnKey };
};
