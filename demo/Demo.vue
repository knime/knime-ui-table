...
<template>
  <div :class="{ 'fix-header': fixHeader }">
    ...
    <div class="toggle-options">
      ...
      <Checkbox v-model="setInitialFiltering" :disabled="!showColumnFilters" @input="forceRerender">
        set initial filters
      </Checkbox>
      ...
      <Checkbox v-model="setInitialSorting" @input="forceRerender">
        set default sorting
      </Checkbox>
...
.fix-header {
  ...
  /* 2 * -12px due to body padding of 12px */
  overflow: visible;
}
