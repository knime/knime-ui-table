...
/**
 * A multiselect component specifically styled for the column filter header of the table. This
 * component also has a modified placeholder which displays the total number of selected items.
 *
 * @emits input event when the selected value changes.
 */
export default {
    components: {
        Checkbox,
