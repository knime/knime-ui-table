...
describe("searchData", () => {
  ...
  describe("searchCell", () => {
    ...
    it("compared string values if missing type", () => {
      ...
      expect(searchCell("2020-10-28T13:02:36+00:00", null, cb, "2020")).toBe(
        true,
      );
    ...
    it("compared string values if missing type and formatter", () => {
      ...
      expect(searchCell("2020-10-28T13:02:36+00:00", null, null, "2020")).toBe(
        true,
      );
    ...
    it("returns false if query is missing", () => {
      ...
      expect(
        searchCell("2020-10-28T13:02:36+00:00", columnTypes.DateTime, cb, null),
      ).toBe(false);
      expect(searchCell(1603890181, columnTypes.DateTime, cb, null)).toBe(
        false,
      );
      ...
      expect(
        searchCell("2020-10-28T13:02:36+00:00", columnTypes.DateTime, cb),
      ).toBe(false);
    ...
    it("is case insensitive", () => {
      ...
      expect(
        searchCell(NaN, columnTypes.Number, (x) => x.toString(), "n"),
      ).toBe(true);
      expect(
        searchCell(["Help"], columnTypes.Array, (x) => JSON.stringify(x), "h"),
      ).toBe(true);
      expect(
        searchCell(
          { test: "test" },
      ...
      expect(
        searchCell("2020-10-28T13:02:36+00:00", columnTypes.DateTime, cb, "T"),
      ).toBe(true);
      expect(
        searchCell(true, columnTypes.Boolean, (x) => JSON.stringify(x), "T"),
      ).toBe(true);
      expect(
        searchCell(null, columnTypes.Object, (x) => JSON.stringify(x), "N"),
      ).toBe(true);
    });
    ...
    describe("formatted searches", () => {
      it("returns false types where a formatter is required but missing", () => {
        ...
        expect(searchCell("James", columnTypes.Nominal, null, "James")).toBe(
          false,
        );
        expect(searchCell(1, columnTypes.Number, null, "1")).toBe(false);
        expect(searchCell(NaN, columnTypes.Number, null, "NaN")).toBe(false);
        expect(searchCell(Infinity, columnTypes.Number, null, "Infinity")).toBe(
          false,
        );
        expect(
          searchCell(
            "2020-10-28T13:02:36+00:00",
            columnTypes.DateTime,
            null,
            "2020",
          ),
        ).toBe(false);
        expect(searchCell(1603890181, columnTypes.DateTime, null, "181")).toBe(
          false,
        );
        ...
        expect(
          searchCell("James", columnTypes.Nominal, undefined, "James"),
        ).toBe(false);
        expect(searchCell(1, columnTypes.Number, undefined, "1")).toBe(false);
        expect(searchCell(NaN, columnTypes.Number, undefined, "NaN")).toBe(
          false,
        );
        expect(
          searchCell(Infinity, columnTypes.Number, undefined, "Infinity"),
        ).toBe(false);
        expect(
          searchCell(
            "2020-10-28T13:02:36+00:00",
        ...
        expect(
          searchCell(1603890181, columnTypes.DateTime, undefined, "181"),
        ).toBe(false);
        expect(searchCell(true, columnTypes.Boolean, undefined, "true")).toBe(
          false,
        );
      });
      ...
      it("uses formatters during search for supported types", () => {
        ...
        expect(searchCell(1603890181, columnTypes.DateTime, cb, "2")).toBe(
          true,
        );
    ...
    describe("searching objects", () => {
      ...
      it("searches stringified objects", () => {
        ...
        expect(
          searchCell({ some: "2020-10-28T13:02:36+00:00" }, t, cb, "2020"),
        ).toBe(true);
      ...
      it("deep searches stringified objects", () => {
        ...
        expect(searchCell({ value: { some: "James" } }, t, cb, "James")).toBe(
          true,
        );
        expect(searchCell({ value: { some: 1 } }, t, cb, "1")).toBe(true);
        expect(searchCell({ value: { some: NaN } }, t, cb, "NaN")).toBe(false);
        expect(
          searchCell({ value: { some: Infinity } }, t, cb, "Infinity"),
        ).toBe(false);
        expect(searchCell({ value: { some: [1] } }, t, cb, "1")).toBe(true);
        expect(searchCell({ value: { some: {} } }, t, cb, "{}")).toBe(true);
        expect(
          searchCell(
            { value: { some: "2020-10-28T13:02:36+00:00" } },
            t,
            cb,
            "2020",
          ),
        ).toBe(true);
        expect(searchCell({ value: { some: 1603890181 } }, t, cb, "181")).toBe(
          true,
        );
      ...
      it("searches formatted objects and object properties", () => {
        ...
        expect(searchCell({ some: {} }, t, cb, "{}")).toBe(true);
        expect(
          searchCell({ some: "2020-10-28T13:02:36+00:00" }, t, cb, "someValue"),
        ).toBe(true);
        expect(
          searchCell({ some: "2020-10-28T13:02:36+00:00" }, t, cb, "2020"),
        ).toBe(true);
    ...
    describe("searching arrays", () => {
      ...
      it("searches stringified arrays", () => {
        ...
        expect(searchCell([[1]], t, cb, "1")).toBe(true);
        expect(searchCell([{}], t, cb, "{}")).toBe(true);
        expect(searchCell(["2020-10-28T13:02:36+00:00"], t, cb, "2020")).toBe(
          true,
        );
      ...
      it("deep searches stringified arrays", () => {
        expect(searchCell([{ value: undefined }], t, cb, "{}")).toBe(true);
        expect(searchCell([{ value: {} }], t, cb, "{")).toBe(true);
        expect(searchCell([{ value: { some: "1" } }], t, cb, "some")).toBe(
          true,
        );
        expect(searchCell([{ value: { some: "1" } }], t, cb, "1")).toBe(true);
        expect(searchCell([{ value: { some: "James" } }], t, cb, "James")).toBe(
        ...
        expect(searchCell([{ value: { some: 1 } }], t, cb, "1")).toBe(true);
        expect(searchCell([{ value: { some: NaN } }], t, cb, "NaN")).toBe(
          false,
        );
        expect(
          searchCell([{ value: { some: Infinity } }], t, cb, "Infinity"),
        ...
        expect(
          searchCell([{ value: { some: 1603890181 } }], t, cb, "181"),
        ).toBe(true);
        expect(searchCell([{ value: { some: true } }], t, cb, "true")).toBe(
          true,
        );
        expect(searchCell([{ value: { some: null } }], t, cb, "null")).toBe(
          true,
        );
      });
    });
