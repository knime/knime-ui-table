...
describe('useScrollToElement', () => {
    let toggleButton: HTMLElement, listContainer: HTMLElement, listItem: HTMLElement;
    ...
    describe('scrollTo in popover', () => {
        it('should scroll popover such that element appears at the bottom', () => {
            ...
            const { scrollTo } = useScrollToElement({ toggleButton: ref(toggleButton) });
            scrollTo(listItem);
    ...
    describe('scrollTo in window', () => {
        ...
        */
        ...
        it('should scroll window such that element appears at the bottom', () => {
            ...
            const { scrollTo } = useScrollToElement({ toggleButton: ref(toggleButton) });
            scrollTo(listItem);
            expect(window.scrollTo).toHaveBeenCalledWith(windowScrollX, windowBottomEdgeMax - window.innerHeight);
        });
        ...
        it('should scroll window such that element appears at the top', () => {
            ...
            const { scrollTo } = useScrollToElement({ toggleButton: ref(toggleButton) });
            scrollTo(listItem);
            expect(window.scrollTo).toHaveBeenCalledWith(windowScrollX, windowTopEdgeMin);
        });
