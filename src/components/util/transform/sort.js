import { columnTypes } from '~/config/table/table.config';
    ...
    return groupedData
        .map(({ data, groupInd }) => data
            ...
            .sort(({ row: row1 }, { row: row2 }) => {
                ...
                let val1Missing = typeof rawVal1 === 'undefined' || rawVal1 === null;
                let val2Missing = typeof rawVal2 === 'undefined' || rawVal2 === null;
